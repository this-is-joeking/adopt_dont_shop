...
RSpec.describe 'admin shelters show page' do
  it 'contains the shelets name and full address' do
    shelter = Shelter.create(name: 'Mystery Building', street: '123 Main St', city: 'Irvine', state: 'CA',
                             zip: '12345', foster_program: false, rank: 9)
  ...
  it 'has a statistics section which includes average age of all adoptable pets' do
    ...
    shelter1 = Shelter.create!(name: 'Test Shelter', street: '123 Main St', city: 'Irvine', state: 'CA', zip: '12345',
  ...
  it 'shows the number of pets that have been adopted' do
    ...
    shelter1 = Shelter.create!(name: 'Test Shelter', street: '123 Main St', city: 'Irvine', state: 'CA', zip: '12345',
                               foster_program: false, rank: 9)
    application = pet1.applications.create!(name: 'John Smith', street: '123 N Central Ave.', city: 'Denver',
    ...
    expect(page).to have_content('Number of Adopted Pets: 3')
